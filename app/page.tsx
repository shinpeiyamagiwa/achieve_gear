        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <Button className="bg-orange-500 hover:bg-orange-600 ml-8 whitespace-nowrap" asChild>
      ...
      <main>
        ...
        <div className="bg-orange-50 py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-8">こんな悩みはありませんか？</h2>
        ...
        <div id="features" className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              <h2 className="text-base text-orange-500 font-semibold tracking-wide uppercase">特徴</h2>
                ...
                {[
                  {
                    ...
                    description: "経験豊富な専属コンサルタントが、あなたの目標達成をきめ細かくサポートします。",
                  },
                  {
                    name: "パーソナライズされた戦略立案",
                    description: "あなたの強みと課題を分析し、最適な目標達成戦略を一緒に作成します。",
                  },
                  {
                    name: "定期的な進捗管理",
                    description: "週次のチェックインで進捗を確認し、必要に応じて戦略を調整します。",
                  },
                  {
                    name: "24時間サポート体制",
                    description: "目標達成に関する質問や悩みを、いつでもサポートチームに相談できます。",
                  },
                ].map((feature) => (
        ...
        <div id="pricing" className="bg-white py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">シンプルな料金プラン</h2>
            ...
            <div className="mt-12 max-w-lg mx-auto">
              <div className="rounded-lg shadow-sm divide-y divide-gray-200">
                <div className="p-6">
                  <h3 className="text-2xl font-semibold text-gray-900">AchieveGearプレミアムプラン</h3>
                  <p className="mt-4 text-3xl font-extrabold text-gray-900">
                    30,000円 <span className="text-base font-medium text-gray-500">/ 月</span>
                  </p>
                  <p className="mt-1 text-sm text-gray-500">*年間契約の場合、2ヶ月分無料</p>
                  <Button className="mt-8 block w-full bg-orange-500 text-white">無料相談を予約する</Button>
                </div>
                <div className="pt-6 pb-8 px-6">
                  <h4 className="text-sm font-medium text-gray-900 tracking-wide uppercase">含まれるサービス</h4>
        ...
        <div id="faq" className="bg-gray-50 py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-12">よくある質問</h2>
            <div className="space-y-8">
              {[
                ...
                <div key={faq.question} className="bg-white shadow overflow-hidden rounded-lg">
