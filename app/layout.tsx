...
export const metadata: Metadata = {
  title: "AchieveGear - 継続、目標達成ができないあなたへ、目標達成支援サービス",
  description:
    "AchieveGearは、専属サポートメンバーがあなたの目標達成をサポートするサービスです。パーソナライズされた戦略と進捗管理で、夢を現実に変えます。目標設定から習慣化まで、確実な達成へと導きます。",
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AchieveGear - 継続、目標達成ができないあなたへ、目標達成支援サービス",
      },
    ],
  },
  generator: "v0.dev",
