...
export const metadata: Metadata = {
  title: "AchieveGear - 専属コンサルタントによる目標達成支援サービス",
  description:
    "AchieveGearは、専属コンサルタントがあなたの目標達成をサポートするサービスです。パーソナライズされた戦略と進捗管理で、夢を現実に変えます。目標設定から習慣化まで、確実な達成へと導きます。",
  keywords: "目標達成, パーソナルコンサルティング, 習慣化, モチベーション管理, 進捗管理, 目標設定",
  icons: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/%E3%82%B9%E3%82%AF%E3%83%AA%E3%83%BC%E3%83%B3%E3%82%B7%E3%83%A7%E3%83%83%E3%83%88%202025-02-15%2013.09.07.jpeg-MMVs08RQKuUbD1A9qaa0IcgFASuhjR.png",
        width: 1200,
        height: 630,
        alt: "AchieveGear - 目標達成支援サービス",
      },
    ],
  },
    generator: 'v0.dev'
